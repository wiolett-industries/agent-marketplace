...
- When creating or updating document content, use HTML (the editor renders HTML).
- `papers_list_documents` supports `search`, `page`, and `limit` — use search to find specific documents before editing.
